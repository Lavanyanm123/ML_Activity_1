...
# No built-in feature importance for KNN, so use a placeholder zero array
...
# 1. Feature Importance Placeholder Bar Plot (all zeros)
fig1, ax1 = plt.subplots()
sns.barplot(x=importances, y=features, ax=ax1, palette="viridis")
ax1.set_title("Feature Importance (KNN has no coefficients)")
figures.append(fig1)
...
current = 0
root = tk.Tk()
root.title("K-Nearest Neighbors Visualizations")
