...
# Generate synthetic classification data resembling flower features and species (3 classes)
...
# TKinter GUI window for plots with Next button
current = 0
root = tk.Tk()
root.title("Random Forest Visualizations")
